...
export default function PublishCasePage() {
  ...
  async function publish() {
    ...
    try {
      const response = await fetch("/api/cases", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ category: area.title, topic, situation, desiredOutcome: details.desiredOutcome, attentionMode: details.attentionMode, region: details.region, commune: details.commune }) });
